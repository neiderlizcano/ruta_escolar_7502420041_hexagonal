...
class OperacionesBasicasConductorUseCasesTest {
    ...
    void deberiaListarBuscarYEliminarConductoresCorrectamente() {
        ...
        Conductor c1 = new Conductor("Juan", "Lopez", "111", "LIC111", "C2", "3001", EstadoTrabajador.ACTIVO);
        Conductor c2 = new Conductor("Maria", "Perez", "222", "LIC222", "C3", "3002", EstadoTrabajador.INACTIVO);
        ...
        assertEquals("Juan", buscado.get().getNombres());
        ...
        assertEquals("Maria", despuesDeEliminar.get(0).getNombres());
    }
}
